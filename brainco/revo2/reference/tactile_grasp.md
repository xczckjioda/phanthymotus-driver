# 触觉灵巧手自适应抓取示例 (https://www.brainco-hz.com/docs/revolimb-hand/revo2/tactile_grasp.html)
...
| data_reader.py | 实时采集 Revo 2 电容式触觉传感器数据，维护固定长度缓冲区。 |
